...
| `APP-16` | **Beállítások — egy helyen, és paneltípusként.** Nem modális ablak: panel, mint minden más, tehát **odatehető amellé, amit épp állítasz** — a Prometheus-végpont a metrika-panel mellé, ami nem tud csatlakozni. Több mint száz beállítás lesz, ezért **kereshető**, és a palettából (`APP-01`) is megtalálható |
| `APP-17` | **Ami clusterhez tartozik, az a clusteré**: engedélyezés, csak-olvasás, csoport, „ez prod" jelölés, Prometheus-végpont, proxy, segéd-engedély. Ugyanaz a beállítás **a flotta-panelből is elérhető** — a flotta az *állapotot* mutatja, a beállítás a *döntést*, és a kettő egy dolog két nézete, nem két másolat |
| `APP-18` | **Veszélyes zóna, elkülönítve**: előzmények törlése, elrendezések visszaállítása, csak-olvasás kikapcsolása egy prod clusteren. Ezek nem férnek meg a témaválasztó mellett |
| `APP-19` | **Beállítások exportálása és megosztása**: egy csapat ugyanazt a cluster-csoportosítást, ugyanazokat a mentett nézeteket és figyelőszabályokat használhassa. **Hitelesítő adat soha nem megy vele** |
| `APP-20` | **Nincs telemetria.** Nem beállítás, hanem döntés, és ki van mondva: az alkalmazás magától nem küld sehova semmit. Amit a segéd küld, azt a `ASK-08` szabályozza, és az alapból ki van kapcsolva |
