# The two earlier plans

The round-04 brief cites these by name and the designer did not have them — the values were
recovered from the brief's verbatim quotes instead. They are here so the next round can read the
